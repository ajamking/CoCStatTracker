...
public class LeaderSetUserNamesGuideLine : BaseRequestHandler
{
    public LeaderSetUserNamesGuideLine()
    {
        Header = "Руководство";
    ...
    override public void Execute(BotUserRequestParameters parameters)
    {
        try
        {
            ...
            answer.AppendLine(StylingHelper.MakeItStyled("Краткое руководство по рассылке бота.\n", UiTextStyle.Header));
            ...
            answer.AppendLine(StylingHelper.MakeItStyled("Имейте ввиду следующее:" +
                ...
                "\n3. Если вы нажмете кнопку включить рассылку без простановки ChatId - операция завершится успешно, но рассылка приходить не будет, потому что некуда.", UiTextStyle.Subtitle));
